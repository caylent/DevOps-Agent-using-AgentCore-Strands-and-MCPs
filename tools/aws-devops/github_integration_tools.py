...
def create_optimization_pull_request(
    ...
    try:
        ...
        # Prepare PR content
        pr_title = f"AWS {optimization_type.title()} Optimization"
...
def update_iac_via_github(
    ...
    try:
        ...
        pr_title = f"Infrastructure Update: {iac_tool.title()} Configuration Changes"
...
---
*This pull request was automatically generated by AWS DevOps Agent*
"""
